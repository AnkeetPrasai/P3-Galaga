...
\begin{DoxyCompactList}\small\item\em \mbox{\hyperlink{class_display}{Display}} on screen what has been rendered to the window so far. \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{class_display}{Display}} on screen what has been rendered to the window so far. 
...
\item 
C\+:/\+GALAGA/\+Galaga/include/\+SFML/\+Window/Window.\+hpp\end{DoxyCompactItemize}
