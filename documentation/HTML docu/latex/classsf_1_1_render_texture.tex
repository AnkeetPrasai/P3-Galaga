...
After drawing to the render-\/texture and calling \mbox{\hyperlink{class_display}{Display}}, you can retrieve the updated texture using this function, and draw it using a sprite (for example). The internal \mbox{\hyperlink{classsf_1_1_texture}{sf\+::\+Texture}} of a render-\/texture is always the same instance, so that it is possible to call this function once and keep a reference to the texture even after it is modified.
...
\item 
C\+:/\+GALAGA/\+Galaga/include/\+SFML/\+Graphics/Render\+Texture.\+hpp\end{DoxyCompactItemize}
